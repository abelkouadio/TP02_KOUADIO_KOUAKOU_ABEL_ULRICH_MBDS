...
@WebServlet(name = "ServletUsers",
     ...
     initParams = {
         @WebInitParam(name = "ressourceDir", value = "D:\\WORKSPACE\\JAVA2EE\\jsp-master (1)\\jsp-master")
     }
)
public class ServletUsers extends HttpServlet {
    ...
    public User rechercherUtilisateur(HttpServletRequest request) {
      ...
      public void modifierUtilisateur(HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        public void deleteUtilisateur(HttpServletRequest request) throws UnsupportedEncodingException {
     
      
          String login;
        login = request.getParameter("login");
           Server.uh.removeUserFromId(login);
